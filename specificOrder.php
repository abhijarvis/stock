			...
			<div class="panel-body">
				...
				<form class="form-horizontal" id="submitOrderForm" action="php_action/updatePayment.php" method="POST"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-9"> 
							<input type="text" class="form-control" name="name" id="name" value="<?php if(!empty($row)) { echo $row['client_name']; } ?>" readonly="readonly">
						</div>
					</div>
					...
					<label class="control-label col-sm-2" for="contact">Contact</label>
						<div class="col-sm-9"> 
							<input type="text" class="form-control" name="contact" id="contact" value="<?php if(!empty($row)) { echo $row['client_contact']; } ?>" readonly="readonly">
						</div>
					</div>

					<h4 style="margin-top:40px;">Order Details</h4><hr style="margin-top: 15px;">
					<div class="form-group">
					...
					<label class="control-label col-sm-2" for="name">Selected Product</label>
						<div class="col-sm-9"> 
							<input type="text" class="form-control" name="product_name" id="product_name" value="<?php if(!empty($row)) { echo $row['product_name']; } ?>" readonly="readonly">      
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9"> 
							<input type="text" class="form-control" name="product_id" id="product_id" value="<?php if(!empty($row)) { echo $row['product_id']; }  ?>" readonly="readonly">      
						</div>
					</div> 
					...
					<label class="control-label col-sm-2" for="contact">No of items</label>
						<div class="col-sm-9"> 
							<input type="number" class="form-control" name="numberOfItems" id="numberOfItems" value="<?php if(!empty($row)) { echo $row['noOfProducts']; }?>" readonly="readonly">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9"> 
							<input type="text" width="100px" class="form-control" name="vat" id="vat" value="<?php if(!empty($row)) { echo $row['vat']; }   ?>" readonly="readonly">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9"> 
							<input type="text" width=100px class="form-control" name="discount" id="discount" value="<?php if(!empty($row)) { echo $row['discount']; } ?>" readonly="readonly">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							$pidrow = $strresult->fetch_assoc();
							}
							if(!empty($pid)) { echo $pidrow['rate']; }
							?>" readonly="readonly">
						</div>
					</div>
					...
					<label class="control-label col-sm-2" for="date">Sub-total</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" name="subTotal" id="subTotal" value="<?php if(!empty($row)) { echo $row['sub_total']; } ?>"
						readonly="readonly">
						</div>
					</div>
					...
					<label class="control-label col-sm-2" for="date">Discount to be applied</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" name="discounted" id="discounted" value="<?php if(!empty($row)) { echo $row['discount']; }  ?>"
						readonly="readonly">
						</div>
					</div>

					<br>
					<p>After applying 18% vat to the discounted total</p><br>
					<div class="form-group">
					<label class="control-label col-sm-2" for="date">Total payable</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" name="total" id="total" value="<?php   if(!empty($row)) { echo $row['total_amount']; }  ?>"
						readonly="readonly">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="paymentType" id="paymentType" value="<?php  if(!empty($row)) { echo $row['payment_type']; }  ?>" readonly="readonly"> 
						</div>
					</div>
					...
					<label class="control-label col-sm-2" for="contact">Amount Paid</label>
						<div class="col-sm-9"> 
							<input type="text" class="form-control" name="paid" id="paid" value="<?php if(!empty($row)) { echo $row['paid']; } ?>" readonly="readonly">
						</div>
					</div>
					...
					<div class="check"><p>Collect the due amount and make an update in the "Due" field below.</p>
						<div class="form-group">
							...
							<?php 
							/*if($row['due'] == 0){
								echo '<input type="text" class="form-control" name="due" id="due" value="0" readonly="readonly">';
							} else {
								echo'<input type="text" class="form-control" name="due" id="due" value="'; if(!empty($row)) { echo $row["due"]; } '">';
							}*/?>
								<input type="text" class="form-control" name="due" id="due" value="<?php if(!empty($row)) { echo $row['due']; } ?>">
							</div>
						</div>
					</div>
